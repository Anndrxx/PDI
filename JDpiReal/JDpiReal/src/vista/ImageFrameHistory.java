...
public class ImageFrameHistory {
    ...
    public class Nodo {
         ...
         private Nodo(FrameImagen elemento) {
    ...
    public int getIndiceFromButton(JButton boton){
        Nodo n = cabeza;
        int indice = 0;
        return auxiliarGetIndiceFromButton(indice, n, boton);
    }
    
    public int auxiliarGetIndiceFromButton(int indice, Nodo n, JButton boton){
        if(n == null) return -1;
        if(n.elemento.getBoton() == boton) return indice;
        return auxiliarGetIndiceFromButton(indice+1, n.siguiente, boton);
    }
     ...
     */
     public void agregaFinal(FrameImagen elemento) {
    ...
    public ImageFrameHistory copia() {
      ImageFrameHistory lista = new ImageFrameHistory();
      Nodo nodo = this.cabeza;
      return auxiliarCopia(lista, nodo);
    }

    private ImageFrameHistory auxiliarCopia(ImageFrameHistory l, Nodo n){
      //Caso base
      if(n == null) return l;
     ...
     *                 si es distinto de <code>null</code>.
     */
     public void agregaInicio(FrameImagen elemento) {
         if(elemento == null) return;
         Nodo nodo = new Nodo(elemento);
     ...
     *                 si es distinto de <code>null</code>.
     */
     public void inserta(int i, FrameImagen elemento) {
       if(elemento == null) return;
     ...
     */
     public void elimina(FrameImagen elemento) {
     ...
     */
     public FrameImagen eliminaPrimero() {
     ...
     *         <code>null</code> si la lista es vacía.
     */
     public FrameImagen eliminaUltimo() {
         if(esVacia()) return null;
         Nodo eliminado = rabo;
         if(longitud == 1) limpia();
         else{
     ...
     */
     public boolean contiene(FrameImagen elemento) {
     ...
     */
    public ImageFrameHistory reversa() {
        ImageFrameHistory lista = new ImageFrameHistory();
        Nodo nodo = rabo;
        return auxiliarReversa(lista, nodo);
    }

    private ImageFrameHistory auxiliarReversa(ImageFrameHistory l, Nodo n){
        // Caso Base
        if(n == null) return l;
        // Caso Recursivo
        l.agregaFinal(n.elemento);
    ...
    private FrameImagen auxiliarGet(int i, Nodo nodo){
      //caso base
     ...
     */
    public int indiceDe(FrameImagen elemento) {
        Nodo n = cabeza;
        int indice = 0;
        return auxiliarIndiceDe(indice, n, elemento);
    }

    private int auxiliarIndiceDe(int indice, Nodo n, FrameImagen elemento){
        if(n == null) return -1;
     ...
     *         <tt>false</tt> en otro caso.
     */
    public boolean equals(ImageFrameHistory lista) {
    ...
    private boolean auxiliarEquals(Nodo nodo, int i, ImageFrameHistory lista){
     ...
     **/
     ...
     private Nodo buscaNodo(FrameImagen e){
       Nodo n = cabeza;
       if(e == null) return null;
       return auxiliarBuscaNodo(n,e);
     }

     private Nodo auxiliarBuscaNodo(Nodo n, FrameImagen e){
        // Casos Base
